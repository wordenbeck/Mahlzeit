...
-- Generated: 2026-05-26T07:46:32.813Z

BEGIN;

INSERT INTO recipes (workspace_id, created_by, title, description, servings, prep_time_min, difficulty, category, ingredients, instructions, tags, recipe_type, ai_confidence, ai_warnings, source_caption, source_author, source_thumbnail)
VALUES (
  'default',
  'harvest-bot',
  ...
  '[]'::jsonb,
  '["vegetarisch","meal-prep"]'::jsonb,
  'dessert',
  0.7000000000000001,
  '["Zubereitung unklar strukturiert"]'::jsonb,
  'Einfach, gesund und so SAFTIG. Schokoladen Brownies OHNE ZUCKER und OHNE MEHL. 🍫 
...
Alle Zutaten außer den Schokola'::text,
  'www.instagram.com',
...
VALUES (
  ...
  '["schnell","meal-prep"]'::jsonb,
  'hauptgericht',
  0.75,
  '["Sehr wenige Zutaten extrahiert"]'::jsonb,
...
Über 20 Kilo Fett hab ich dam'::text,
  'www.instagram.com',
...
VALUES (
  ...
  '[]'::jsonb,
  '["vegan","high-protein"]'::jsonb,
  'snack',
  0.5,
  '["Sehr wenige Zutaten extrahiert","Zubereitung unklar strukturiert"]'::jsonb,
...
Schneide die Kartoffeln in sehr dünne Scheiben oder hobel sie gleichmäß'::text,
  'www.instagram.com',
...
VALUES (
  ...
  '["vegetarisch","schnell","low-calorie","meal-prep"]'::jsonb,
  'hauptgericht',
  1,
  '[]'::jsonb,
...
Das hier ist der Faul-aber-shredded-Plan – vier Mahlzeiten, die so einfach sind, dass du sie auch nach einer 10-Stunden-Schicht no'::text,
  'www.instagram.com',
...
VALUES (
  ...
  '["vegetarisch","high-protein"]'::jsonb,
  'hauptgericht',
  1,
  '[]'::jsonb,
  '☕ Kaffee liefert Koffein, das im Gehirn die Adenosin-Rezeptoren blockiert, sodass Müdigkeitssignale ausbleiben und gleichzeitig über erhöhte Dopaminaktivität Fokus und Stimmung verbessert werden, während Chlorogensäuren als starke Antioxidantien Entzündungswege wie NF-κB hemmen und so langfristig di'::text,
  'www.instagram.com',
...
z. B. Frischkäse, Avocado, Salat, Tomaten, Gurke, Hummus oder was ihr gerade da hab'::text,
  'www.instagram.com',
...
VALUES (
  ...
  '["schnell","high-protein","low-calorie"]'::jsonb,
  'hauptgericht',
  1,
  '[]'::jsonb,
  'Diese ￼High Protein Hackfleisch Ofentacos sind unglaublich lecker und haben 20g Eiweiß pro Stück 🌮💪🏾
...
Zubereitung:
Alles außer Zwiebeln mixen ➝ Zwiebeln unterkne'::text,
  'www.instagram.com',
...
VALUES (
  ...
  '[]'::jsonb,
  '["vegetarisch","schnell","high-protein"]'::jsonb,
  'hauptgericht',
  0.7000000000000001,
  '["Zubereitung unklar strukturiert"]'::jsonb,
  'TESTO SPAGHETTI sind ein Bi⚡️tzrezept für den schnellen Feierabend! Würdest du sie testen? 🤔 so gehts ⤵️
...
VALUES (
  ...
  '["high-protein","low-calorie"]'::jsonb,
  'hauptgericht',
  1,
  '[]'::jsonb,
  'High Protein Asia Nudeln für alle die es lieben beim Asiaten zu bestellen 🍜💪🏾
...
Nun ausrollen, nach Wahl belegen und bei 200 Grad für ca 15'::text,
  'www.instagram.com',
...
🍯 Datteln
Datteln liefern schnell verfügbare Glukose und Fruktose, die direkt in die Zellen aufgenommen werden. Pathophysiologisch steigt dadurch der Blutzucker zügig an, was kurzfristig Energie liefert. Gleichzeitig enthalten sie Polyp'::text,
  'www.instagram.com',
...
Zubereitung: 
200 Grad Umluft für 20-25 Minuten. '::text,
  'www.instagram.com',
...
Zubereitung:
30-40 Minuten bei 180 Grad Umluft '::text,
  'www.instagram.com',
...
VALUES (
  ...
  '[]'::jsonb,
  '["vegetarisch","schnell","high-protein","low-calorie"]'::jsonb,
  'hauptgericht',
  0.7000000000000001,
  '["Zubereitung unklar strukturiert"]'::jsonb,
  'Anzeige | High Protein Edamame Taccos 
...
Gewürze: Salz, More Spices Knobilicous @morenu'::text,
  'www.instagram.com',
...
Enjoy immediately or prep '::text,
  'www.instagram.com',
...
VALUES (
  ...
  '["vegetarisch","high-protein","low-calorie"]'::jsonb,
  'hauptgericht',
  1,
  '[]'::jsonb,
  'Diese High Protein Schoko Brötchen sind unglaublich lecker und super um mitzunehmen 💪🏾🍪
...
Weil ich einen Vollzeitjob habe und keine Zeit habe, ständig'::text,
  'www.instagram.com',
...
VALUES (
  ...
  45,
  'schwer',
  '["vegetarisch","fleisch","fisch"]'::jsonb,
...
In einer Pfanne kurz scharf anbraten dann Hitze auf 2/3 st'::text,
  'www.instagram.com',
...
Zubereitung: 
Kartoffeln (roh) in die Pfanne u'::text,
  'www.instagram.com',
...
Belegen und nochmal 15 Minuten bei'::text,
  'www.instagram.com',
...
VALUES (
  ...
  '[]'::jsonb,
  'Auch einfache Zutaten können ziemlich spannende Biochemie enthalten 👀
🥔 Kleine Kartoffeln enthalten im Verhältnis mehr Schale – und direkt darunter sitzen viele Mineralstoffe und sekundäre Pflanzenstoffe. Außerdem liefern sie resistente Stärke, besonders wenn sie nach dem Kochen abkühlen. Das enth'::text,
  'www.instagram.com',
...
Zubereitung: 
≈Etwa 20 Minuten bei 180 Grad Umluft in den Ofen. Wenn'::text,
  'www.instagram.com',
...
Welches vegane Hack könnt ihr empfehlen? Das Mühlenhack hat zwar stabile Werte, aber wa'::text,
  'www.instagram.com',
...
Zubereitung: 
Lachs bei 180 Grad Umluft in den Ofen. V'::text,
  'www.instagram.com',
...
Zubereitung: 
Kartoffeln in kleine Würfel schneiden. Etwas Öl und Salz dazu. Mit dem'::text,
  'www.instagram.com',
...
Zubereitung: 
Gekochten Reis in etwas Sesamöl anbraten. Verquirltes Ei darüber geben, '::text,
  'www.instagram.com',
...
Zubereitung: 
Hähnchenbrust in dünne Schnitzel schneiden. Wie im Video marinie'::text,
  'www.instagram.com',
